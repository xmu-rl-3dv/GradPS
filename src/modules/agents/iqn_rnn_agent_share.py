...
class IQNRNNAgentShare(nn.Module):
    def __init__(self, input_shape, args):
        super(IQNRNNAgentShare, self).__init__()
        self.args = args
        ...
        self.fc1 = ShareLayer(input_shape, args.rnn_hidden_dim, 'C1', agent=args.n_agents, K=min(args.n_agents, args.cluster_k))
        self.rnn = nn.GRUCell(args.rnn_hidden_dim, args.rnn_hidden_dim)
        self.grad = GradLayer(args.rnn_hidden_dim, 'C1', agent=args.n_agents)
